...
Namespace LibrarySeleniumWD
    ...
    Public Class InteractionWD
        ...
        Sub Reflesh()
            ...
            End Try
        End Sub
        Function GetAttribute(element As String, attribute As String, Optional typeIdentification As typeIdentification = typeIdentification.xpath) As Boolean
            If String.IsNullOrEmpty(element) Then Return True
            If String.IsNullOrEmpty(attribute) Then Return True
