...
Namespace LibraryAppium
    ...
    Public Class SeleniumAppiumHelper
        ...
        'Private Shared testServerAddress As New Uri("http://192.168.0.11:4723/wd/hub")
        'Private Shared testServerAddress As New Uri("http://192.168.43.130:4723/wd/hub")
    ...
    Public Class InteractionAppium
        ...
        Function Open(url As String) As Boolean
            Try
                ...
                Return True
            Catch ex As Exception
                HandlerError("LibraryobjAppium.InteractionWDBrowseerStack.Open: " & url & " Error:" & ex.Message & " - " & ex.InnerException.ToString)
                Return False
            End Try
        End Function
        Function WaitForPageToLoad(Optional timeOut As Integer = 0) As Boolean
            ...
            Try
                ...
                objAppium.Manage.Timeouts().SetPageLoadTimeout(System.TimeSpan.FromSeconds(p_timeout))
            Catch ex As Exception
                HandlerError("LibraryobjAppium.InteractionWDBrowseerStack.WaitForPageToLoad: Error: " & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
