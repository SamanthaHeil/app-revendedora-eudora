'*********************************************************************************************************************************
'Create by LeanTest Automation 3.2 in 29/09/2017 14:17:53 (By LeanTest Automation Test 2.0) 
'User:............ Admin
'Domain:.......... LeanTest Execution Automation
'Environment:..... Automation Project
'Application...... EudoraApp
'Functionality:... Abrir Filtros
'Master Test:..... No Defined
'TableTest:....... test_EudoraApp_Abrir_Filtros
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal

Namespace test_EudoraApp_Abrir_Filtros
    Public Class test_EudoraApp_Abrir_Filtros
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
            Try
                If StartTest() Then
                    Do While p_CountTest <> 0
                        Try
                            Test.TestLog("Evidência antes de Abrir Filtrar", "", "", typelog.NA)

                            If CBool(vbtnFiltrar) Then
                                Test.Click("br.com.grupoboticario.eudorarepresentante.staging:id/component_filter_button_text", vbtnFiltrar, typeIdentification.id) 'click Filtrar
                                Test.TestLog("Verificar resultado após clique em Filtrar", "Verificar resultado após clique em Filtrar", "Verificação realizada com sucesso", typelog.Passed)
                            End If
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
                HandlerError("test_EudoraApp_Abrir_Filtros.test_EudoraApp_Abrir_Filtros.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_EudoraApp_Abrir_Filtros.test_EudoraApp_Abrir_Filtros.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
