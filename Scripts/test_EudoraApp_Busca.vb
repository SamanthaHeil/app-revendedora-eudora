'*********************************************************************************************************************************
'Create by LeanTest Automation 3.2 in 22/08/2017 16:13:43 (By LeanTest Automation Test 2.0) 
'User:............ Admin
...
'TableTest:....... test_EudoraApp_Busca
'*********************************************************************************************************************************
Imports Lean.Test.Automation.Framework.LibraryGlobal.LibGlobal

Namespace test_EudoraApp_Busca
    Public Class test_EudoraApp_Busca
        Public Sub New()
        End Sub
        Public Function Run() As Boolean
            ...
            Catch ex As Exception
                p_errorDescription = "Menssage error: " & ex.Message.ToString
				HandlerError("test_EudoraApp_Busca.test_EudoraApp_Busca.Run: " & ex.Message)
        ...
        Private Function StartTest() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As Exception
                HandlerError("test_EudoraApp_Busca.test_EudoraApp_Busca.StartTest" & ex.StackTrace & " - " & ex.Message)
                Return False
            End Try
        End Function
    End Class
